...
class BaseLightningModule(pl.LightningModule):
    ...
    def configure_optimizers(self):
        if self.cfg.train.optimizer.type == "Adam":
            ...
            # scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer,base_lr=0.001,max_lr= 0.01,step_size_up=1000, cycle_momentum=False)
    ...
    #         lr_scale = min(1.0, float(self.trainer.global_step + 1) / 1000)
    #
    #         for pg in optimizer.param_groups:
    #             pg["lr"] = lr_scale * self.cfg.train.optimizer.lr
